...
var (
	...
	// ErrMnemonicWordInvalid is returned when attempting to unmarshal mnemonics
	// containing unknown words.
	ErrMnemonicWordInvalid = errors.New("Mnemonic contains invalid word")

	// ErrMnemonicLengthInvalid is returned when mnemonic contains an invalid
	// number of words.
	ErrMnemonicLengthInvalid = errors.New("Mnemonic length incorrect")
)
